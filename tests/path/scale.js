...
test('tail weirdness passes regression test', t => {
  ...
  t.is(
    tailScale(0).toString(),
    'M290.7,204.5c-9,0,-9,9,-18,9s-9,-9,-18,-9s-9,9,-18,9s-9,-9,-18,-9s-9,9,-18,9s-9,-9,-18,-9s-9,9,-18,9'
  );
  t.is(
    tailScale(0.2).toString(),
    'M289.9,208.1c-9,0,-9,1.8,-18,1.8s-9,-1.8,-18,-1.8s-9,1.8,-18,1.8s-9,-1.8,-18,-1.8s-9,1.8,-18,1.8s-9,-1.8,-18,-1.8s-9,1.8,-18,1.8'
  );
  t.is(
    tailScale(0.5).toString(),
    'M288.7,213.5c-9,0,-9,-9,-18,-9s-9,9,-18,9s-9,-9,-18,-9s-9,9,-18,9s-9,-9,-18,-9s-9,9,-18,9s-9,-9,-18,-9'
  );
  t.is(
    tailScale(0.666).toString(),
    'M289.4,210.5c-9,0,-9,-3,-18,-3s-9,3,-18,3s-9,-3,-18,-3s-9,3,-18,3s-9,-3,-18,-3s-9,3,-18,3s-9,-3,-18,-3'
  );
  t.is(
    tailScale(0.8).toString(),
    'M289.9,208.1c-9,0,-9,1.8,-18,1.8s-9,-1.8,-18,-1.8s-9,1.8,-18,1.8s-9,-1.8,-18,-1.8s-9,1.8,-18,1.8s-9,-1.8,-18,-1.8s-9,1.8,-18,1.8'
  );
  t.is(
    tailScale(1).toString(),
    'M290.7,204.5c-9,0,-9,9,-18,9s-9,-9,-18,-9s-9,9,-18,9s-9,-9,-18,-9s-9,9,-18,9s-9,-9,-18,-9s-9,9,-18,9'
  );
...
test('supports mixing S and C after M', t => {
  const pathScale = Path.scale(['M258,351c-44-9-67-43-36-60', 'M270,340s-93-4-54-50']);
